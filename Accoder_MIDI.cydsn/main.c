    ...
    case USB_MIDI_CONTROL_CHANGE:
            switch (midiMsg[USB_EVENT_BYTE1]/8)
            {
                case 0: 
                    ...
                    {
                    Tabs_1_Write(Tabs_1_Read() & ~(0x01 << midiMsg[USB_EVENT_BYTE1]));
                    }
                    else
                    {
                    Tabs_1_Write(Tabs_1_Read() | (0x01 << midiMsg[USB_EVENT_BYTE1]));    
                ...
                case 1:
                    if (midiMsg[USB_EVENT_BYTE2] < 63)
                    {
                    Tabs_2_Write(Tabs_2_Read() & ~(0x01 << (midiMsg[USB_EVENT_BYTE1]-8)));
                    }
                    else
                    {
                    Tabs_2_Write(Tabs_2_Read() | (0x01 << (midiMsg[USB_EVENT_BYTE1]-8)));    
                ...
                case 2:
                    if (midiMsg[USB_EVENT_BYTE2] < 63)
                    {
                    Tabs_3_Write(Tabs_3_Read() & ~(0x01 << (midiMsg[USB_EVENT_BYTE1]-16)));
                    }
                    else
                    {
                    Tabs_3_Write(Tabs_3_Read() | (0x01 << (midiMsg[USB_EVENT_BYTE1]-16)));    
