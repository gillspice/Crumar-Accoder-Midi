...
*
* \funcusage
*  \snippet LED_OutB_SUT.c usage_LED_OutB_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet LED_OutB_SUT.c usage_LED_OutB_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet LED_OutB_SUT.c usage_LED_OutB_Read  
*******************************************************************************/
...
* preferred LED_OutB_Read() API because the 
* LED_OutB_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet LED_OutB_SUT.c usage_LED_OutB_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: LED_OutB_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use LED_OutB_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - LED_OutB_0_INTR       (First pin in the list)
    *  - LED_OutB_1_INTR       (Second pin in the list)
    *  - ...
    *  - LED_OutB_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet LED_OutB_SUT.c usage_LED_OutB_SetInterruptMode
    *******************************************************************************/
    void LED_OutB_SetInterruptMode(uint16 position, uint16 mode) 
                            
    {
		if((position & LED_OutB_0_INTR) != 0u) 
		{ 
			 LED_OutB_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet LED_OutB_SUT.c usage_LED_OutB_ClearInterrupt
    *******************************************************************************/
