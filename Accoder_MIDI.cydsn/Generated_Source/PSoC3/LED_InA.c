...
*
* \funcusage
*  \snippet LED_InA_SUT.c usage_LED_InA_Write
*******************************************************************************/
void LED_InA_Write(uint8 value) 
{
    uint8 staticBits = (LED_InA_DR & (uint8)(~LED_InA_MASK));
    LED_InA_DR = staticBits | ((uint8)(value << LED_InA_SHIFT) & LED_InA_MASK);
}


/*******************************************************************************
* Function Name: LED_InA_SetDriveMode
****************************************************************************//**
*
...
*
* \funcusage
*  \snippet LED_InA_SUT.c usage_LED_InA_SetDriveMode
*******************************************************************************/
void LED_InA_SetDriveMode(uint8 mode) 
{
	CyPins_SetPinDriveMode(LED_InA_0, mode);
}


/*******************************************************************************
* Function Name: LED_InA_Read
****************************************************************************//**
*
...
*
* \funcusage
*  \snippet LED_InA_SUT.c usage_LED_InA_Read  
*******************************************************************************/
uint8 LED_InA_Read(void) 
{
    return (LED_InA_PS & LED_InA_MASK) >> LED_InA_SHIFT;
}


/*******************************************************************************
* Function Name: LED_InA_ReadDataReg
****************************************************************************//**
*
...
* preferred LED_InA_Read() API because the 
* LED_InA_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet LED_InA_SUT.c usage_LED_InA_ReadDataReg 
*******************************************************************************/
uint8 LED_InA_ReadDataReg(void) 
{
    return (LED_InA_DR & LED_InA_MASK) >> LED_InA_SHIFT;
}


/* If interrupt is connected for this Pins component */ 
#if defined(LED_InA_INTSTAT) 
