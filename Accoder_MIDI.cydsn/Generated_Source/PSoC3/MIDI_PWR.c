...
*
* \funcusage
*  \snippet MIDI_PWR_SUT.c usage_MIDI_PWR_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet MIDI_PWR_SUT.c usage_MIDI_PWR_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet MIDI_PWR_SUT.c usage_MIDI_PWR_Read  
*******************************************************************************/
...
* preferred MIDI_PWR_Read() API because the 
* MIDI_PWR_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet MIDI_PWR_SUT.c usage_MIDI_PWR_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: MIDI_PWR_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use MIDI_PWR_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - MIDI_PWR_0_INTR       (First pin in the list)
    *  - MIDI_PWR_1_INTR       (Second pin in the list)
    *  - ...
    *  - MIDI_PWR_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet MIDI_PWR_SUT.c usage_MIDI_PWR_SetInterruptMode
    *******************************************************************************/
    void MIDI_PWR_SetInterruptMode(uint16 position, uint16 mode) 
                            
    {
		if((position & MIDI_PWR_0_INTR) != 0u) 
		{ 
			 MIDI_PWR_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet MIDI_PWR_SUT.c usage_MIDI_PWR_ClearInterrupt
    *******************************************************************************/
