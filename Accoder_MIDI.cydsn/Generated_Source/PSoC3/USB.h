...
#define USB_ENABLE_CDC_CLASS_API   (0u != (0u))
...
uint8  USB_GetEPState(uint8 epNumber)              CYREENTRANT;
uint16 USB_GetEPCount(uint8 epNumber)              CYREENTRANT;
...
uint16 USB_ReadOutEP(uint8 epNumber, uint8 pData[], uint16 length)
                                                                CYREENTRANT;
void   USB_EnableOutEP(uint8 epNumber)             CYREENTRANT;
void   USB_DisableOutEP(uint8 epNumber)            ;
void   USB_Force(uint8 bState)                     ;
uint8  USB_GetEPAckState(uint8 epNumber)           CYREENTRANT;
...
void USB_DisableSofInt(void) ;
    ...
    void USB_InitEP_DMA(uint8 epNumber, const uint8 *pData) CYREENTRANT;   
