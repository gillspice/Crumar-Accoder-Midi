...
void USB_MIDI_Init(void) 
{
    ...
    *
    *******************************************************************************/
    void USB_MIDI_OUT_Service(void) CYREENTRANT
    {
    ...
    *
    *******************************************************************************/
    void USB_MIDI_IN_Service(void) CYREENTRANT
    {
...
*/
    ...
    *
    *******************************************************************************/
    uint8 USB_MIDI1_GetEvent(void) CYREENTRANT
    {
        uint8 msgRtn = 0u;
        uint8 rxData;
    ...
    *
    *******************************************************************************/
    uint8 USB_MIDI2_GetEvent(void) CYREENTRANT
    {
        uint8 msgRtn = 0u;
        uint8 rxData;
