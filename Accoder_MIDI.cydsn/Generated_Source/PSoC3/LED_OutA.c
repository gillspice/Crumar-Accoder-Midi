...
*
* \funcusage
*  \snippet LED_OutA_SUT.c usage_LED_OutA_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet LED_OutA_SUT.c usage_LED_OutA_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet LED_OutA_SUT.c usage_LED_OutA_Read  
*******************************************************************************/
...
* preferred LED_OutA_Read() API because the 
* LED_OutA_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet LED_OutA_SUT.c usage_LED_OutA_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: LED_OutA_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use LED_OutA_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - LED_OutA_0_INTR       (First pin in the list)
    *  - LED_OutA_1_INTR       (Second pin in the list)
    *  - ...
    *  - LED_OutA_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet LED_OutA_SUT.c usage_LED_OutA_SetInterruptMode
    *******************************************************************************/
    void LED_OutA_SetInterruptMode(uint16 position, uint16 mode) 
                            
    {
		if((position & LED_OutA_0_INTR) != 0u) 
		{ 
			 LED_OutA_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet LED_OutA_SUT.c usage_LED_OutA_ClearInterrupt
    *******************************************************************************/
