...
*
*******************************************************************************/
cystatus CyDmaChEnable(uint8 chHandle, uint8 preserveTds) CYREENTRANT
{
    cystatus status = CYRET_BAD_PARAM;
...
*
*******************************************************************************/
cystatus CyDmaChDisable(uint8 chHandle) CYREENTRANT
{
    cystatus status = CYRET_BAD_PARAM;
...
*
*******************************************************************************/
cystatus CyDmaClearPendingDrq(uint8 chHandle) CYREENTRANT
{
    cystatus status = CYRET_BAD_PARAM;
...
*
*******************************************************************************/
cystatus CyDmaChPriority(uint8 chHandle, uint8 priority) CYREENTRANT
{
    uint8 value;
    cystatus status = CYRET_BAD_PARAM;
...
*
*******************************************************************************/
cystatus CyDmaChSetInitialTd(uint8 chHandle, uint8 startTd) CYREENTRANT
{
    cystatus status = CYRET_BAD_PARAM;
...
cystatus CyDmaChSetConfiguration(uint8 chHandle, uint8 burstCount, uint8 requestPerBurst,
                                 uint8 tdDone0, uint8 tdDone1, uint8 tdStop) CYREENTRANT
{
    cystatus status = CYRET_BAD_PARAM;
...
*
*******************************************************************************/
uint8 CyDmaTdAllocate(void) CYREENTRANT
{
    uint8 interruptState;
...
*
*******************************************************************************/
cystatus CyDmaTdSetAddress(uint8 tdHandle, uint16 source, uint16 destination) CYREENTRANT
{
    cystatus status = CYRET_BAD_PARAM;
    reg16 *convert;
